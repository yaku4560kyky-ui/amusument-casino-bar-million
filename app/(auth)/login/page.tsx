...
export default function LoginPage() {
  ...
  return (
    <Card className="mx-auto w-full max-w-md border-amber-400/20 bg-card/95 shadow-2xl shadow-black/40">
      <CardHeader className="text-center">
        <CardTitle className="text-3xl text-amber-300">Million & EXCEED</CardTitle>
        <CardDescription>運営管理システムにログイン</CardDescription>
      </CardHeader>
      <CardContent>
